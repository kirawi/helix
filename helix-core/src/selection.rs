...
use std::{borrow::Cow, io, iter, slice};
...
// Serializable impl
impl Selection {
    pub fn serialize<W: std::io::Write>(&self, writer: &mut W) -> io::Result<()> {
    ...
    pub fn deserialize<R: std::io::Read>(reader: &mut R) -> io::Result<Self> {
